...
<div class="bg-white p-8 rounded shadow-md w-2/5 mx-auto text-center">
            ...
            <form action="<?= base_url('editar-usuario/aceptar') ?>" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring focus:border-blue-300" value="<?= $usuario->secret ?>" required />
                </div>

                <div class="mb-4">
                    <label for="nombres" class="block text-sm font-medium text-gray-600">Nombres:</label>
                    <input type="text" id="nombres" name="nombres" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring focus:border-blue-300" value="<?= $usuario->nombres ?>" required />
                </div>

                <div class="mb-4">
                    <label for="apellidos" class="block text-sm font-medium text-gray-600">Apellidos:</label>
                    <input type="text" id="apellidos" name="apellidos" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring focus:border-blue-300" value="<?= $usuario->apellidos ?>" required />
                </div>

                <div class="mb-4">
                    <label for="cedula" class="block text-sm font-medium text-gray-600">Cedula:</label>
                    <input type="number" id="cedula" min="10000000" max="99999999" name="cedula" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring focus:border-blue-300" value="<?= $usuario->cedula ?>" required />
                </div>
