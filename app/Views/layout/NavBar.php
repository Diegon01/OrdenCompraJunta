    ...
    <nav class=" bg-blue-500 p-2 text-white flex justify-between items-center shadow-md fixed top-0 w-full z-50">
        <!-- Logo a la izquierda -->
    ...
    <nav class=" bg-blue-500 p-2 text-white flex justify-between items-center shadow-md" style="opacity: 0; pointer-events: none;">
        <!-- Logo a la izquierda -->
        <a class="hover:no-underline text-lg font-semibold box-shadow-hover" href="<?= base_url('/') ?>">
            <img src="<?= base_url('assets/images/LogoJunta.png') ?>" alt="Logo" width="80" height="80">
        </a>
